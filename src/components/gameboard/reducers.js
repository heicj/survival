export const UPDATE_GAMEBOARD_TILE = 'UPDATE_GAMEBOARD_TILE';

import transparentTree2 from '../../img/transparentTree2.png';
import transparentPond from '../../img/transparentPond.png';

const initialState = [
  { 'id': 0, 'img': transparentTree2 }, { 'id': 1, 'img': transparentTree2 }, { 'id': 2, 'img': transparentTree2 }, { 'id': 3, 'img': transparentTree2 }, { 'id': 4 }, { 'id': 5 }, { 'id': 6 }, { 'id': 7 }, { 'id': 8 }, { 'id': 9 },
  { 'id': 10 }, { 'id': 11, 'img': transparentPond }, { 'id': 12 }, { 'id': 13 }, { 'id': 14 }, { 'id': 15 }, { 'id': 16 }, { 'id': 17 }, { 'id': 18 }, { 'id': 19 },
